...
YarpNavigationClientImpl::YarpNavigationClientImpl(const std::string &componentName, int & argc, char ** argv)
:	SmartACE::SmartComponent(componentName, argc, argv)
{  }

YarpNavigationClientImpl::YarpNavigationClientImpl(const std::string &componentName, int & argc, char ** argv, const ACE_Sched_Params &sched_params)
:	SmartACE::SmartComponent(componentName, argc, argv, NULL, sched_params)
{  }

YarpNavigationClientImpl::~YarpNavigationClientImpl() 
{  }

Smart::StatusCode YarpNavigationClientImpl::run(void)
{
...
void YarpNavigationClientImpl::closeAllAssociatedTasks(const int &taskShutdownTimeLimit)
{
...
void YarpNavigationClientImpl::cleanUpComponentResources()
{
