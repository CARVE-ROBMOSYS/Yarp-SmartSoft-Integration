...
public:
		...
		protected:
			 ...
			 */
			std::string localization_server_name;
		...
		public:
			 ...
			 */
			inline std::string getLocalization_server_name() const { return localization_server_name; }
			inline std::string getMap_server_name() const { return map_server_name; }
			inline std::string getNavigation_server_name() const { return navigation_server_name; }
			
			void to_ostream(std::ostream &os = std::cout) const
			{
				os << "Settings(";
				os << "localization_server_name = " << localization_server_name << ", ";
				os << "map_server_name = " << map_server_name << ", ";
				os << "navigation_server_name = " << navigation_server_name << ", ";
				os << ")\n";
			}
