...
void ParamUpdateHandler::loadParameter(SmartACE::SmartIniParameter &parameter)
{
	...
	try
	{
		...
		//
		// parameter Settings
		if(parameter.getString("Settings", "localization_server_name", commitState.Settings.localization_server_name))
		{
			globalState.Settings.localization_server_name = commitState.Settings.localization_server_name;
		}
		if(parameter.getString("Settings", "map_server_name", commitState.Settings.map_server_name))
		{
			globalState.Settings.map_server_name = commitState.Settings.map_server_name;
		}
		if(parameter.getString("Settings", "navigation_server_name", commitState.Settings.navigation_server_name))
		{
			globalState.Settings.navigation_server_name = commitState.Settings.navigation_server_name;
		}
