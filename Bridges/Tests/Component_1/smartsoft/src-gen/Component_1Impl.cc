...
Component_1Impl::Component_1Impl(const std::string &componentName, int & argc, char ** argv)
:	SmartACE::SmartComponent(componentName, argc, argv)
{  }

Component_1Impl::Component_1Impl(const std::string &componentName, int & argc, char ** argv, const ACE_Sched_Params &sched_params)
:	SmartACE::SmartComponent(componentName, argc, argv, NULL, sched_params)
{  }

Component_1Impl::~Component_1Impl() 
{  }

Smart::StatusCode Component_1Impl::run(void)
{
...
void Component_1Impl::closeAllAssociatedTasks(const int &taskShutdownTimeLimit)
{
...
void Component_1Impl::cleanUpComponentResources()
{
