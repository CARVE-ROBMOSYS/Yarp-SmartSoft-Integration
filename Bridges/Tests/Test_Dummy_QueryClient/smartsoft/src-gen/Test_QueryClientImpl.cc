...
Test_QueryClientImpl::Test_QueryClientImpl(const std::string &componentName, int & argc, char ** argv)
:	SmartACE::SmartComponent(componentName, argc, argv)
{  }

Test_QueryClientImpl::Test_QueryClientImpl(const std::string &componentName, int & argc, char ** argv, const ACE_Sched_Params &sched_params)
:	SmartACE::SmartComponent(componentName, argc, argv, NULL, sched_params)
{  }

Test_QueryClientImpl::~Test_QueryClientImpl() 
{  }

Smart::StatusCode Test_QueryClientImpl::run(void)
{
...
void Test_QueryClientImpl::closeAllAssociatedTasks(const int &taskShutdownTimeLimit)
{
...
void Test_QueryClientImpl::cleanUpComponentResources()
{
