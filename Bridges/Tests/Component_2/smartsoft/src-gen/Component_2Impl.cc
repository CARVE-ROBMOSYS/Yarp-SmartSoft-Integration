...
Component_2Impl::Component_2Impl(const std::string &componentName, int & argc, char ** argv)
:	SmartACE::SmartComponent(componentName, argc, argv)
{  }

Component_2Impl::Component_2Impl(const std::string &componentName, int & argc, char ** argv, const ACE_Sched_Params &sched_params)
:	SmartACE::SmartComponent(componentName, argc, argv, NULL, sched_params)
{  }

Component_2Impl::~Component_2Impl() 
{  }

Smart::StatusCode Component_2Impl::run(void)
{
...
void Component_2Impl::closeAllAssociatedTasks(const int &taskShutdownTimeLimit)
{
...
void Component_2Impl::cleanUpComponentResources()
{
