...
TestV3_StateSlaveImpl::TestV3_StateSlaveImpl(const std::string &componentName, int & argc, char ** argv)
:	SmartACE::SmartComponent(componentName, argc, argv)
{  }

TestV3_StateSlaveImpl::TestV3_StateSlaveImpl(const std::string &componentName, int & argc, char ** argv, const ACE_Sched_Params &sched_params)
:	SmartACE::SmartComponent(componentName, argc, argv, NULL, sched_params)
{  }

TestV3_StateSlaveImpl::~TestV3_StateSlaveImpl() 
{  }

Smart::StatusCode TestV3_StateSlaveImpl::run(void)
{
...
void TestV3_StateSlaveImpl::closeAllAssociatedTasks(const int &taskShutdownTimeLimit)
{
...
void TestV3_StateSlaveImpl::cleanUpComponentResources()
{
