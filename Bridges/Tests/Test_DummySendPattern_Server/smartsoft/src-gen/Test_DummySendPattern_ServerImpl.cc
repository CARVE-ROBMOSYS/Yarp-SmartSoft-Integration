...
Test_DummySendPattern_ServerImpl::Test_DummySendPattern_ServerImpl(const std::string &componentName, int & argc, char ** argv)
:	SmartACE::SmartComponent(componentName, argc, argv)
{  }

Test_DummySendPattern_ServerImpl::Test_DummySendPattern_ServerImpl(const std::string &componentName, int & argc, char ** argv, const ACE_Sched_Params &sched_params)
:	SmartACE::SmartComponent(componentName, argc, argv, NULL, sched_params)
{  }

Test_DummySendPattern_ServerImpl::~Test_DummySendPattern_ServerImpl() 
{  }

Smart::StatusCode Test_DummySendPattern_ServerImpl::run(void)
{
...
void Test_DummySendPattern_ServerImpl::closeAllAssociatedTasks(const int &taskShutdownTimeLimit)
{
...
void Test_DummySendPattern_ServerImpl::cleanUpComponentResources()
{
