...
Component_3Impl::Component_3Impl(const std::string &componentName, int & argc, char ** argv)
:	SmartACE::SmartComponent(componentName, argc, argv)
{  }

Component_3Impl::Component_3Impl(const std::string &componentName, int & argc, char ** argv, const ACE_Sched_Params &sched_params)
:	SmartACE::SmartComponent(componentName, argc, argv, NULL, sched_params)
{  }

Component_3Impl::~Component_3Impl() 
{  }

Smart::StatusCode Component_3Impl::run(void)
{
...
void Component_3Impl::closeAllAssociatedTasks(const int &taskShutdownTimeLimit)
{
...
void Component_3Impl::cleanUpComponentResources()
{
