...
Test_DummySendPattern_ClientImpl::Test_DummySendPattern_ClientImpl(const std::string &componentName, int & argc, char ** argv)
:	SmartACE::SmartComponent(componentName, argc, argv)
{  }

Test_DummySendPattern_ClientImpl::Test_DummySendPattern_ClientImpl(const std::string &componentName, int & argc, char ** argv, const ACE_Sched_Params &sched_params)
:	SmartACE::SmartComponent(componentName, argc, argv, NULL, sched_params)
{  }

Test_DummySendPattern_ClientImpl::~Test_DummySendPattern_ClientImpl() 
{  }

Smart::StatusCode Test_DummySendPattern_ClientImpl::run(void)
{
...
void Test_DummySendPattern_ClientImpl::closeAllAssociatedTasks(const int &taskShutdownTimeLimit)
{
...
void Test_DummySendPattern_ClientImpl::cleanUpComponentResources()
{
