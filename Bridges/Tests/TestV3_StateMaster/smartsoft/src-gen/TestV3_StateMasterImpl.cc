...
TestV3_StateMasterImpl::TestV3_StateMasterImpl(const std::string &componentName, int & argc, char ** argv)
:	SmartACE::SmartComponent(componentName, argc, argv)
{  }

TestV3_StateMasterImpl::TestV3_StateMasterImpl(const std::string &componentName, int & argc, char ** argv, const ACE_Sched_Params &sched_params)
:	SmartACE::SmartComponent(componentName, argc, argv, NULL, sched_params)
{  }

TestV3_StateMasterImpl::~TestV3_StateMasterImpl() 
{  }

Smart::StatusCode TestV3_StateMasterImpl::run(void)
{
...
void TestV3_StateMasterImpl::closeAllAssociatedTasks(const int &taskShutdownTimeLimit)
{
...
void TestV3_StateMasterImpl::cleanUpComponentResources()
{
