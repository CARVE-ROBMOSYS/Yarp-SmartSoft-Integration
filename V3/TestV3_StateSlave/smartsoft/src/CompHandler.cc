...
/*
	COMP->stateSlave->defineStates("MainState_1", "subState_1");
	COMP->stateSlave->defineStates("MainState_2", "subState_2");
	COMP->stateSlave->defineStates("MainState_3", "subState_3");
*/
