...
start)
	...
	xterm -fg red -title "SSH: icub@127.0.0.1" -e 'echo;echo "Starting remote SSH session at icub@127.0.0.1 ..."; echo;echo;ssh -X icub@127.0.0.1 "cd /home/icub/SOFTWARE/deployment_3.6//System_Scenario2_Gazebo.deployment; pwd; bash --login -i -e start-localhost.sh start"' &
	echo $! >> $PID_FILE
...
stop)
	...
	xterm -title "stopping icub@127.0.0.1" -e 'echo;echo "Starting remote SSH session at icub@127.0.0.1 ..."; echo;echo;ssh -X icub@127.0.0.1 "cd /home/icub/SOFTWARE/deployment_3.6//System_Scenario2_Gazebo.deployment; pwd; bash --login -i -e start-localhost.sh stop"' 
	echo $! >> $PID_FILE
