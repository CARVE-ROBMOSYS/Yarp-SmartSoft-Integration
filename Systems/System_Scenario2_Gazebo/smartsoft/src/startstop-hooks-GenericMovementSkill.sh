#!/bin/bash
#
# Start-Stop-Hooks for component GenericMovementSkill
#
...
pre-start)
	...
	bash startstop-hooks-component-GenericMovementSkill.sh pre-start
...
post-start)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-GenericMovementSkill.sh post-start
...
pre-stop)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-GenericMovementSkill.sh pre-stop
...
post-stop)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-GenericMovementSkill.sh post-stop
