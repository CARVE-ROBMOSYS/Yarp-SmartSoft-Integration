#!/bin/bash
#
# Start-Stop-Hooks for component YarpNavigationClient
#
...
pre-start)
	...
	bash startstop-hooks-component-YarpNavigationClient.sh pre-start
...
post-start)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-YarpNavigationClient.sh post-start
...
pre-stop)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-YarpNavigationClient.sh pre-stop
...
post-stop)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-YarpNavigationClient.sh post-stop
