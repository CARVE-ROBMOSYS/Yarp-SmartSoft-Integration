#!/bin/bash
#
# Start-Stop-Hooks for component VisionSkill_Simulator
#
...
pre-start)
	...
	bash startstop-hooks-component-VisionSkill_Simulator.sh pre-start
...
post-start)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-VisionSkill_Simulator.sh post-start
...
pre-stop)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-VisionSkill_Simulator.sh pre-stop
...
post-stop)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-VisionSkill_Simulator.sh post-stop
