#!/bin/bash
#
# Start-Stop-Hooks for component BT_tickDispatcher
#
...
pre-start)
	...
	bash startstop-hooks-component-BT_tickDispatcher.sh pre-start
...
post-start)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-BT_tickDispatcher.sh post-start
...
pre-stop)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-BT_tickDispatcher.sh pre-stop
...
post-stop)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-BT_tickDispatcher.sh post-stop
