#!/bin/bash
#
# Start-Stop-Hooks for component GraspingSkill
#
...
pre-start)
	...
	bash startstop-hooks-component-GraspingSkill.sh pre-start
...
post-start)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-GraspingSkill.sh post-start
...
pre-stop)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-GraspingSkill.sh pre-stop
...
post-stop)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-GraspingSkill.sh post-stop
