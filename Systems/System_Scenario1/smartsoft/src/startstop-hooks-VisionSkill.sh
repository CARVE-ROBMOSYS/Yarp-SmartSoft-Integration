#!/bin/bash
#
# Start-Stop-Hooks for component VisionSkill
#
...
pre-start)
	...
	bash startstop-hooks-component-VisionSkill.sh pre-start
...
post-start)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-VisionSkill.sh post-start
...
pre-stop)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-VisionSkill.sh pre-stop
...
post-stop)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-VisionSkill.sh post-stop
