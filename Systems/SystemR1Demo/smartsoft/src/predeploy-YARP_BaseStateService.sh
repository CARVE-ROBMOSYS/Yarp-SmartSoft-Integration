#!/bin/bash
#
# This script is run prior to deployment of component YARP_BaseStateService
...
#source $REFERENCED_PROJECT_BridgeV3_FromYarp_BaseStateService/smartsoft/src/predeploy.sh
