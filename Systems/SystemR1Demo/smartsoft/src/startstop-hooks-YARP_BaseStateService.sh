#!/bin/bash
#
# Start-Stop-Hooks for component YARP_BaseStateService
#
...
pre-start)
	...
	bash startstop-hooks-component-BridgeV3_FromYarp_BaseStateService.sh pre-start
...
post-start)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-BridgeV3_FromYarp_BaseStateService.sh post-start
...
pre-stop)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-BridgeV3_FromYarp_BaseStateService.sh pre-stop
...
post-stop)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-BridgeV3_FromYarp_BaseStateService.sh post-stop
