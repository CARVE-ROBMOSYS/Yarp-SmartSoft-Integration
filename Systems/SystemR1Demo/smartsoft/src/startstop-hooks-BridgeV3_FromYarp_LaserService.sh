#!/bin/bash
#
# Start-Stop-Hooks for component BridgeV3_FromYarp_LaserService
#
...
pre-start)
	...
	bash startstop-hooks-component-BridgeV3_FromYarp_LaserService.sh pre-start
...
post-start)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-BridgeV3_FromYarp_LaserService.sh post-start
...
pre-stop)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-BridgeV3_FromYarp_LaserService.sh pre-stop
...
post-stop)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-BridgeV3_FromYarp_LaserService.sh post-stop
