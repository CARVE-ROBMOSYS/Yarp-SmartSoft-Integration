#!/bin/bash
#
# This script is run prior to deployment of component BridgeV3_ToYarp_CommNavigationVelocity
...
#source $REFERENCED_PROJECT_BridgeV3_ToYarp_CommNavigationVelocity/smartsoft/src/predeploy.sh
