#!/bin/bash
#
# This script is run prior to deployment of component BridgeV3_FromYarp_LaserService
...
#source $REFERENCED_PROJECT_BridgeV3_FromYarp_LaserService/smartsoft/src/predeploy.sh
