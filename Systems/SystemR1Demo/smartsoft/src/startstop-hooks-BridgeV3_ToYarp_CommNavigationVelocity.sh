#!/bin/bash
#
# Start-Stop-Hooks for component BridgeV3_ToYarp_CommNavigationVelocity
#
...
pre-start)
	...
	bash startstop-hooks-component-BridgeV3_ToYarp_CommNavigationVelocity.sh pre-start
...
post-start)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-BridgeV3_ToYarp_CommNavigationVelocity.sh post-start
...
pre-stop)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-BridgeV3_ToYarp_CommNavigationVelocity.sh pre-stop
...
post-stop)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-BridgeV3_ToYarp_CommNavigationVelocity.sh post-stop
