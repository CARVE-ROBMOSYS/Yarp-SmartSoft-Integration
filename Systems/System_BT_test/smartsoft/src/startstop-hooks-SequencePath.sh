#!/bin/bash
#
# Start-Stop-Hooks for component SequencePath
#
...
pre-start)
	...
	bash startstop-hooks-component-SequencePath.sh pre-start
...
post-start)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-SequencePath.sh post-start
...
pre-stop)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-SequencePath.sh pre-stop
...
post-stop)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-SequencePath.sh post-stop
