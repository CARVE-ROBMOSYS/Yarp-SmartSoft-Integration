#!/bin/bash
#
# Start-Stop-Hooks for component BT_TickManager
#
...
pre-start)
	...
	bash startstop-hooks-component-BT_TickManager.sh pre-start
...
post-start)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-BT_TickManager.sh post-start
...
pre-stop)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-BT_TickManager.sh pre-stop
...
post-stop)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-BT_TickManager.sh post-stop
