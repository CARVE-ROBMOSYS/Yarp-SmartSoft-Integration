#!/bin/bash
#
# Start-Stop-Hooks for component PathSequencer
#
...
pre-start)
	...
	bash startstop-hooks-component-PathSequencer.sh pre-start
...
post-start)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-PathSequencer.sh post-start
...
pre-stop)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-PathSequencer.sh pre-stop
...
post-stop)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-PathSequencer.sh post-stop
