#!/bin/bash
#
# Start-Stop-Hooks for component BT_runner
#
...
pre-start)
	...
	bash startstop-hooks-component-BT_runner.sh pre-start
...
post-start)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-BT_runner.sh post-start
...
pre-stop)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-BT_runner.sh pre-stop
...
post-stop)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-BT_runner.sh post-stop
