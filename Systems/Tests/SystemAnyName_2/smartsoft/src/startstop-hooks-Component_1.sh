#!/bin/bash
#
# Start-Stop-Hooks for component Component_1
#
...
pre-start)
	...
	bash startstop-hooks-component-Component_1.sh pre-start
...
post-start)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-Component_1.sh post-start
...
pre-stop)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-Component_1.sh pre-stop
...
post-stop)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-Component_1.sh post-stop
