#!/bin/bash
#
# Start-Stop-Hooks for component Component_3
#
...
pre-start)
	...
	bash startstop-hooks-component-Component_3.sh pre-start
...
post-start)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-Component_3.sh post-start
...
pre-stop)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-Component_3.sh pre-stop
...
post-stop)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-Component_3.sh post-stop
