#!/bin/bash
#
# Start-Stop-Hooks for component Test_QueryServer
#
...
pre-start)
	...
	bash startstop-hooks-component-Test_QueryServer.sh pre-start
...
post-start)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-Test_QueryServer.sh post-start
...
pre-stop)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-Test_QueryServer.sh pre-stop
...
post-stop)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-Test_QueryServer.sh post-stop
