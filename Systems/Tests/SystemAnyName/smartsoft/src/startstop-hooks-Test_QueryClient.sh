#!/bin/bash
#
# Start-Stop-Hooks for component Test_QueryClient
#
...
pre-start)
	...
	bash startstop-hooks-component-Test_QueryClient.sh pre-start
...
post-start)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-Test_QueryClient.sh post-start
...
pre-stop)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-Test_QueryClient.sh pre-stop
...
post-stop)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-Test_QueryClient.sh post-stop
