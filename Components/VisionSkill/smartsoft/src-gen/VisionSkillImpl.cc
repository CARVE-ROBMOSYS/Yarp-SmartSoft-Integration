...
VisionSkillImpl::VisionSkillImpl(const std::string &componentName, int & argc, char ** argv)
:	SmartACE::SmartComponent(componentName, argc, argv)
{  }

VisionSkillImpl::VisionSkillImpl(const std::string &componentName, int & argc, char ** argv, const ACE_Sched_Params &sched_params)
:	SmartACE::SmartComponent(componentName, argc, argv, NULL, sched_params)
{  }

VisionSkillImpl::~VisionSkillImpl() 
{  }

Smart::StatusCode VisionSkillImpl::run(void)
{
...
void VisionSkillImpl::closeAllAssociatedTasks(const int &taskShutdownTimeLimit)
{
...
void VisionSkillImpl::cleanUpComponentResources()
{
