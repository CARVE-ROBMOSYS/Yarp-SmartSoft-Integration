...
void ParamUpdateHandler::loadParameter(SmartACE::SmartIniParameter &parameter)
{
	...
	try
	{
		...
		//
		// parameter Settings
		if(parameter.getString("Settings", "local_port", commitState.Settings.local_port))
		{
			globalState.Settings.local_port = commitState.Settings.local_port;
		}
		if(parameter.getString("Settings", "remote_port", commitState.Settings.remote_port))
		{
			globalState.Settings.remote_port = commitState.Settings.remote_port;
		}
