...
VisionSkill_GazeboImpl::VisionSkill_GazeboImpl(const std::string &componentName, int & argc, char ** argv)
:	SmartACE::SmartComponent(componentName, argc, argv)
{  }

VisionSkill_GazeboImpl::VisionSkill_GazeboImpl(const std::string &componentName, int & argc, char ** argv, const ACE_Sched_Params &sched_params)
:	SmartACE::SmartComponent(componentName, argc, argv, NULL, sched_params)
{  }

VisionSkill_GazeboImpl::~VisionSkill_GazeboImpl() 
{  }

Smart::StatusCode VisionSkill_GazeboImpl::run(void)
{
...
void VisionSkill_GazeboImpl::closeAllAssociatedTasks(const int &taskShutdownTimeLimit)
{
...
void VisionSkill_GazeboImpl::cleanUpComponentResources()
{
