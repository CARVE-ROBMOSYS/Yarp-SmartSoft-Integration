...
public:
		...
		public:
			// default constructor
			SettingsType() {
				local_port = "/VisionSkill_Gazebo:o";
				remote_port = "/world_input_port";
			}
		
			/**
			 * here are the public getters
			 */
			inline std::string getLocal_port() const { return local_port; }
			inline std::string getRemote_port() const { return remote_port; }
			
			void to_ostream(std::ostream &os = std::cout) const
			{
				os << "Settings(";
				os << "local_port = " << local_port << ", ";
				os << "remote_port = " << remote_port << ", ";
				os << ")\n";
			}
