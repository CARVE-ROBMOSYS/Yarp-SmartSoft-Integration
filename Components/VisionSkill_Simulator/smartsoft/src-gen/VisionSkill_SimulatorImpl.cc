...
VisionSkill_SimulatorImpl::VisionSkill_SimulatorImpl(const std::string &componentName, int & argc, char ** argv)
:	SmartACE::SmartComponent(componentName, argc, argv)
{  }

VisionSkill_SimulatorImpl::VisionSkill_SimulatorImpl(const std::string &componentName, int & argc, char ** argv, const ACE_Sched_Params &sched_params)
:	SmartACE::SmartComponent(componentName, argc, argv, NULL, sched_params)
{  }

VisionSkill_SimulatorImpl::~VisionSkill_SimulatorImpl() 
{  }

Smart::StatusCode VisionSkill_SimulatorImpl::run(void)
{
...
void VisionSkill_SimulatorImpl::closeAllAssociatedTasks(const int &taskShutdownTimeLimit)
{
...
void VisionSkill_SimulatorImpl::cleanUpComponentResources()
{
