...
GraspingSkillImpl::GraspingSkillImpl(const std::string &componentName, int & argc, char ** argv)
:	SmartACE::SmartComponent(componentName, argc, argv)
{  }

GraspingSkillImpl::GraspingSkillImpl(const std::string &componentName, int & argc, char ** argv, const ACE_Sched_Params &sched_params)
:	SmartACE::SmartComponent(componentName, argc, argv, NULL, sched_params)
{  }

GraspingSkillImpl::~GraspingSkillImpl() 
{  }

Smart::StatusCode GraspingSkillImpl::run(void)
{
...
void GraspingSkillImpl::closeAllAssociatedTasks(const int &taskShutdownTimeLimit)
{
...
void GraspingSkillImpl::cleanUpComponentResources()
{
