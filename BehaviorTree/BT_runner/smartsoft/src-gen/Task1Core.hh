...
//--------------------------------------------------------------------------
#ifndef _TASK1_CORE_HH
#define _TASK1_CORE_HH
...
#include <Task1ObserverInterface.hh>
...
private:
	...
	std::list<Task1ObserverInterface*> interaction_observers;
protected:
	void notify_all_interaction_observers();
public:
	void attach_interaction_observer(Task1ObserverInterface *observer);
	void detach_interaction_observer(Task1ObserverInterface *observer);

public:
	Task1Core(Smart::IComponent *comp, const bool &useDefaultState=true)
