...
public:
	...
	// trigger user methods
		...
		virtual void handleCommYARP_BT_ConfigParams_configFile(const std::string &filename) = 0;
	
	// extended trigger user methods
	
private:
	// trigger internal methods
	void handleCommYARP_BT_ConfigParams_configFileCore(const std::string &filename);
