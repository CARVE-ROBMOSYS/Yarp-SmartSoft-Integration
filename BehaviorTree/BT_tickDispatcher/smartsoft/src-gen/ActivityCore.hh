...
//--------------------------------------------------------------------------
#ifndef _ACTIVITY_CORE_HH
#define _ACTIVITY_CORE_HH
...
#include <ActivityObserverInterface.hh>
...
private:
	...
	std::list<ActivityObserverInterface*> interaction_observers;
protected:
	void notify_all_interaction_observers();
public:
	void attach_interaction_observer(ActivityObserverInterface *observer);
	void detach_interaction_observer(ActivityObserverInterface *observer);

public:
	ActivityCore(Smart::IComponent *comp, const bool &useDefaultState=true)
