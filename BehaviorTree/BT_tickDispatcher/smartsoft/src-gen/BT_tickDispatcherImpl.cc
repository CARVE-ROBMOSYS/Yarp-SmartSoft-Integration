...
BT_tickDispatcherImpl::BT_tickDispatcherImpl(const std::string &componentName, int & argc, char ** argv)
:	SmartACE::SmartComponent(componentName, argc, argv)
{  }

BT_tickDispatcherImpl::BT_tickDispatcherImpl(const std::string &componentName, int & argc, char ** argv, const ACE_Sched_Params &sched_params)
:	SmartACE::SmartComponent(componentName, argc, argv, NULL, sched_params)
{  }

BT_tickDispatcherImpl::~BT_tickDispatcherImpl() 
{  }

Smart::StatusCode BT_tickDispatcherImpl::run(void)
{
...
void BT_tickDispatcherImpl::closeAllAssociatedTasks(const int &taskShutdownTimeLimit)
{
...
void BT_tickDispatcherImpl::cleanUpComponentResources()
{
