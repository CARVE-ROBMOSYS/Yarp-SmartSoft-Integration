...
#ifndef YARPSMARTSOFT_NAVIGATIONTICKER_H
#define YARPSMARTSOFT_NAVIGATIONTICKER_H
...
class SmartNavigationTicker : public ITickable
{
private:
...
public:
	...
	SmartNavigationTicker();		// TBD: if we want this to be a plugin, this praram in the constructor shall be removed
...
#endif // YARPSMARTSOFT_NAVIGATIONTICKER_H
