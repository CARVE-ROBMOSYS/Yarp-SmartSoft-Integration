#!/bin/bash
#
# Start-Stop-Hooks for component DummySubscriber_instance
#
...
pre-start)
	...
	bash startstop-hooks-component-DummySubscriber.sh pre-start
...
post-start)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-DummySubscriber.sh post-start
...
pre-stop)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-DummySubscriber.sh pre-stop
...
post-stop)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-DummySubscriber.sh post-stop
