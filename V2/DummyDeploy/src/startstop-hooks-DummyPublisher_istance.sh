#!/bin/bash
#
# Start-Stop-Hooks for component DummyPublisher_istance
#
...
pre-start)
	...
	bash startstop-hooks-component-DummyPublisher.sh pre-start
...
post-start)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-DummyPublisher.sh post-start
...
pre-stop)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-DummyPublisher.sh pre-stop
...
post-stop)
	# first, trigger hooks as delivered from component ...
	bash startstop-hooks-component-DummyPublisher.sh post-stop
